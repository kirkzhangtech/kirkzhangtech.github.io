...
- [go语言项目](#go语言项目)
- [1. 入门](#1-入门)
  - [1.1. hello\_world](#11-hello_world)
  - [1.2 命令行参数(os package)](#12-命令行参数os-package)
...
- [7. 接口](#7-接口)
  ...
  - [7.10. 类型断言](#710-类型断言)
  - [7.11. 基于类型断言区别错误类型](#711-基于类型断言区别错误类型)
  - [7.12. 通过类型断言询问行为](#712-通过类型断言询问行为)
  - [7.13. 类型分支](#713-类型分支)
  - [7.14. 示例: 基于标记的XML解码](#714-示例-基于标记的xml解码)
  - [7.15. 一些建议](#715-一些建议)
  - [7.16. any关键字与泛型](#716-any关键字与泛型)
...
- [10. 包和工具](#10-包和工具)
  ...
  - [10.6. 包和命名](#106-包和命名)
  - [10.7. 工具](#107-工具)
    - [10.7.1. 工作区结构](#1071-工作区结构)
    - [10.7.2. 下载包](#1072-下载包)
    - [10.7.3. 构建包](#1073-构建包)
    - [10.7.4. 包文档](#1074-包文档)
    - [10.7.5. 内部包](#1075-内部包)
    - [10.7.6. 查询包](#1076-查询包)
    - [10.7.7 go mod](#1077-go-mod)
- [11. 测试](#11-测试)
  - [11.1 go test](#111-go-test)
  - [11.2 测试函数](#112-测试函数)
    - [11.2.1. 随机测试](#1121-随机测试)
    - [11.2.2. 测试一个命令](#1122-测试一个命令)
    - [11.2.3. 白盒测试](#1123-白盒测试)
    - [11.2.4. 外部测试包](#1124-外部测试包)
    - [11.2.5. 编写有效的测试](#1125-编写有效的测试)
    - [11.2.6. 避免脆弱的测试](#1126-避免脆弱的测试)
...
summary:
1. 算术运算和逻辑运算，比较运算之后的结果都是常量
2. 如果省略初始化表达式则表示使用前面常量的初始化表达式写法，如上面例子
